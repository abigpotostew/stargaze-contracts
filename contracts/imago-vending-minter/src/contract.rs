...
use crate::msg::{ConfigResponse, ExecuteMsg, MintCountResponse, MintPriceResponse, MintableNumTokensResponse, QueryMsg, StartTimeResponse, ImagoVendingMinterCreateMsg};
use crate::state::{ConfigExtension, CONFIG, MINTABLE_NUM_TOKENS, MINTABLE_TOKEN_IDS, MINTER_ADDRS, SG721_ADDRESS, MINTER_LAST_BLOCK, Config};
#[cfg(not(feature = "library"))]
use cosmwasm_std::entry_point;
use cosmwasm_std::{coin, to_binary, Addr, BankMsg, Binary, Coin, CosmosMsg, Deps, DepsMut, Empty, Env, MessageInfo, Order, Reply, ReplyOn, StdError, StdResult, Timestamp, WasmMsg, Decimal, Uint128};
use cw2::set_contract_version;
use cw721_base::{msg::ExecuteMsg as Cw721ExecuteMsg, MintMsg};
use cw_utils::{may_pay, maybe_addr, parse_reply_instantiate_data};
use sg1::checked_fair_burn;
use sg2::query::Sg2QueryMsg;
use sg721_imago::{ExecuteMsg as Sg721ExecuteMsg, InstantiateMsg as Sg721InstantiateMsg};
...
pub fn instantiate(
    ...
    env: Env,
    info: MessageInfo,
    msg: ImagoVendingMinterCreateMsg,
) -> Result<Response, ContractError> {
    set_contract_version(deps.storage, CONTRACT_NAME, CONTRACT_VERSION)?;


    // Check the number of tokens is more than zero and less than the max limit
    if msg.init_msg.num_tokens == 0 || msg.init_msg.num_tokens > MAX_TOKEN_LIMIT {
    ...
    if msg.init_msg.per_address_limit == 0 || msg.init_msg.per_address_limit > MAX_PER_ADDRESS_LIMIT {
    ...
    if MIN_MINT_PRICE > msg.init_msg.unit_price.amount.into() {
    ...
    let submsg = SubMsg {
        msg: WasmMsg::Instantiate {
            ...
            msg: to_binary(&Sg721InstantiateMsg {
                ...
                finalizer: msg.init_msg.finalizer,
                code_uri: msg.init_msg.code_uri.to_string(),
...
pub fn mint_price(deps: Deps, is_admin: bool) -> Result<Coin, StdError> {
    ...
    if is_admin {
        return Ok(coin(AIRDROP_MINT_PRICE, config.extension.unit_price.denom));
    }
