...
use crate::msg::{ConfigResponse, ExecuteMsg, MintCountResponse, MintPriceResponse, MintableNumTokensResponse, QueryMsg, StartTimeResponse, ImagoVendingMinterCreateMsg, CollectionParams, ImagoVendingMinterInitMsgExtension};
use crate::ContractError;
use cosmwasm_std::testing::{mock_dependencies_with_balance, mock_env, mock_info};
use cosmwasm_std::{coin, coins, Addr, Empty, Timestamp, Uint128, Decimal};
...
pub fn mock_init_extension() -> ImagoVendingMinterInitMsgExtension {
    ImagoVendingMinterInitMsgExtension {
        base_token_uri: "https://metadata.publicworks.art".to_string(),
        finalizer: "finalizer_add".to_string(),
        code_uri: "ipfs://code_uri".to_string(),
 ...
 fn mock_collection_params() -> CollectionParams {
    CollectionParams {
        code_id: 1,
...
pub fn mock_create_minter() -> ImagoVendingMinterCreateMsg {
    ImagoVendingMinterCreateMsg {
...
fn setup_minter_contract(
    ...
    let minter_addr = router. instantiate_contract(
        minter_code_id,
        creator.clone(),
        &msg,
        &[],
