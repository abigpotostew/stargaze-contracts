use cosmwasm_std::{Binary, CosmosMsg, Deps, DepsMut, Empty, Env, MessageInfo, Order, StdResult, to_binary, WasmMsg};
#[cfg(not(feature = "library"))]
use cosmwasm_std::entry_point;
use cw2::set_contract_version;
use sg_std::StargazeMsgWrapper;

use sg721_imago::ExecuteMsg as Imago721ExecuteMsg;
...
pub fn execute_finalize(
    ...
    let finalize_msg = Imago721ExecuteMsg::<Empty>::FinalizeTokenUri {
